...
function addon_config():array{$base='/etc/mkauth-huawei-online/config.php';$override='/var/cache/mkauth-huawei-online/config.php';$c=is_file($base)?require $base:[];$o=is_file($override)?require $override:[];return array_merge(is_array($c)?$c:[],is_array($o)?$o:[]);}
