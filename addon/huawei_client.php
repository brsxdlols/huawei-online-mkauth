...
function huawei_exec(array $c,string $commands):string{
    ...
    if(stripos($out,'initial password poses security risks')!==false||stripos($out,'Change now?')!==false)throw new RuntimeException('SSH autenticou, mas o Huawei exige trocar a senha inicial deste usuário. Faça a primeira troca manualmente ou crie um usuário dedicado sem troca pendente.');
